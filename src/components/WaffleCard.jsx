...
const WaffleCard = ({ waffle }) => {
  ...
  return (
    <div className={Styles.waffle__card}>
      {waffle.image ? (
        <img
          src={`${process.env.PUBLIC_URL}/images/waffles/${waffle.image}.jpg`}
          alt={`${waffle.name}`}
        />
      ) : (
        <img
          src={`${process.env.PUBLIC_URL}/images/waffles/basic-waffle.jpg`}
          alt={`not available`}
        />
      )}
      <main>
        ...
        <p
          ...
          onMouseEnter={() => {
            setShouldRenderIngredients(true);
          }}
          onMouseLeave={() => {
            setShouldRenderIngredients(false);
          }}
        >
          ingredients
